...
socket_client.bind("tcp://10.0.2.15:5551") #customer connection
socket_merchant = context.socket(zmq.REP)
socket_merchant.bind("tcp://10.0.2.15:5557") #merchant connection
socket_publish = context.socket(zmq.PUSH)
socket_publish.bind("tcp://10.0.2.15:5556") #publishing mpk
